        ...
        <div class="login-page">
               <div class="form">
                ...
                <form class="login-form" onsubmit="return validateRegistration()" action="validateBestallarReg.php">
                    ...
                    <input type="password"  placeholder="Lösenord"          name="Password"  id="regpassword" required>
                    <input type="password"  placeholder="Bekräfta lösenord" name="regPassword2" id="regpassword2" required>
